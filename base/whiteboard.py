...
class Whiteboard:
    ...
    def __init__(self):
        if Whiteboard.__instance is not None:
            ...
            self.__all_segments_played = False

    def add_all_segments_played(self, all_segments_played):
        self.__all_segments_played = all_segments_played
    ...
    def get_all_segments_played(self):
        return self.__all_segments_played
